  ...
  return (
    ...
    <p className="text-center mb-8">_______________</p>
      <p className="w-1/2 mx-auto text-[18px] font-bold text-gray-600">
        ...
        MongoDB, JWT, JavaScript, Tailwind CSS, Bootstrap, Html5, and CSS3. I am
        fast learner at technical term. I like to learn new technologies and
        apply to my projects for make my projects up to date and fast bug less.
        With my knowledge and practice I am confident & excited to work with
        your organization.
      </p>
      </div>
    </div>
